  ...
  if (!redirectUri || !codeChallenge) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 p-4">
        <div className="w-full max-w-sm rounded-none bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-8 text-center">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 p-4">
      <div className="w-full max-w-sm">
        {/* Card */}
        <div className="rounded-none bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 overflow-hidden shadow-sm">
          ...
          <div className="px-8 pt-8 pb-6 border-b border-neutral-100 dark:border-neutral-800 text-center">
            <div className="flex items-center justify-center gap-3 mb-5">
              ...
              <div className="w-9 h-9 rounded-none bg-[#c44a4a] flex items-center justify-center flex-shrink-0">
              ...
              {/* Claude mark */}
              <div className="w-9 h-9 rounded-none bg-[#D97757] flex items-center justify-center flex-shrink-0">
          ...
          <div className="px-8 py-6">
            {!user ? (
              ...
              <>
                ...
                <form onSubmit={handleLogin} className="space-y-3">
                  <input
                    ...
                    required
                    className="w-full h-9 px-3 rounded-none border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-sm text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 outline-none focus:border-[#c44a4a] transition-colors"
                  />
                  <input
                    type="password"
                  ...
                  <button
                    type="submit"
                    disabled={busy}
                    className="w-full h-9 rounded-none bg-[#c44a4a] text-white text-[11px] font-bold uppercase tracking-widest hover:bg-[#b03d3d] disabled:opacity-50 transition-colors"
                  >
              ...
              <>
                <div className="flex items-center gap-2.5 mb-5 p-3 rounded-none bg-neutral-50 dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 h-9 rounded-none border border-neutral-200 dark:border-neutral-700 text-[11px] font-bold uppercase tracking-widest text-neutral-500 hover:bg-neutral-50 dark:hover:bg-neutral-800 disabled:opacity-50 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    onClick={handleAllow}
                    disabled={busy}
                    className="flex-1 h-9 rounded-none bg-[#c44a4a] text-white text-[11px] font-bold uppercase tracking-widest hover:bg-[#b03d3d] disabled:opacity-50 transition-colors"
                  >
