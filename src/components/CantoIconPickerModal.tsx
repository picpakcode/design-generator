  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-6 pointer-events-none">
        <div
          className="pointer-events-auto w-full max-w-2xl bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 flex flex-col overflow-hidden animate-slide-up"
              ...
              <div className="grid gap-1.5" style={{ gridTemplateColumns: `repeat(auto-fill, minmax(${thumbnailSize + 32}px, 1fr))` }}>
                {filtered.map(a => (
                  <button
                    ...
                    className="flex flex-col items-center gap-1.5 p-2 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/60 border-2 border-transparent hover:border-gray-200 dark:hover:border-gray-600 active:border-gray-400 transition-all group"
                    title={a.name}
                  >
                    <div
                      className="rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center overflow-hidden group-hover:bg-gray-200 dark:group-hover:bg-gray-600 transition-colors w-full"
                    ...
                    <span className="text-[9px] font-medium text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-200 text-center leading-tight w-full"
