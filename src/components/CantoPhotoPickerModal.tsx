  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-6 pointer-events-none">
        <div
          className="pointer-events-auto w-full max-w-3xl bg-white rounded-2xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden animate-slide-up"
        ...
        >
          ...
          <div className="px-5 pt-5 pb-4 flex items-center justify-between border-b border-gray-100 shrink-0">
            <div>
              <h2 className="text-sm font-bold text-gray-900">Product Photos</h2>
          ...
          <div className="px-5 py-3 border-b border-gray-100 shrink-0">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="shrink-0 px-4 h-[38px] text-[11px] font-bold uppercase tracking-widest rounded-xl bg-gray-900 text-white hover:bg-gray-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
              >
              ...
              <div className="grid gap-3" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))' }}>
                {pageResults.map(photo => (
                  <button
                    ...
                    className="group flex flex-col rounded-xl overflow-hidden border-2 border-transparent hover:border-gray-300 active:border-gray-500 bg-gray-50 hover:bg-white transition-all hover:shadow-md text-left"
                    title={photo.name}
                  >
                    <div className="w-full bg-gray-100 overflow-hidden" style={{ height: 110 }}>
          ...
          {searched && !loading && totalPages > 1 && (
            <div className="px-5 py-3 border-t border-gray-100 shrink-0 flex items-center justify-between gap-4">
              <button
                onClick={() => goToPage(page - 1)}
                disabled={page === 0}
                className="flex items-center gap-1.5 px-3 h-8 rounded-lg border border-gray-200 text-[11px] font-semibold text-gray-500 hover:border-gray-400 hover:text-gray-700 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
              >
                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
