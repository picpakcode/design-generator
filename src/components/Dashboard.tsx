      ...
      <aside className="w-72 shrink-0 flex flex-col bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-700 shadow-sm z-10">
        ...
        <nav className="flex-1 overflow-y-auto">
          ...
          >
            ...
            <Link href="/changelog" className="w-full flex items-center gap-2 px-4 py-1.5 text-[12px] text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white transition-colors">
