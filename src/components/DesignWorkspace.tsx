...
function CanvasContentGallery({ design, settings }: { design: DesignState; settings: FormatSettings }) {
...
function CanvasContentGalleryIcons({ design, settings }: { design: DesignState; settings: FormatSettings }) {
  const productImg = design.assets[0]
  const textureImg = design.assets[1]
  const logoImg    = design.assets[2]
...
function CanvasContent({ design, settings }: { design: DesignState; settings: FormatSettings }) {
  const productImg = design.assets[0]
  const textureImg = design.assets[1]
  const logoImg    = design.assets[2]
...
function CanvasContentIcons({ design, settings }: { design: DesignState; settings: FormatSettings }) {
  const productImg = design.assets[0]
  const textureImg = design.assets[1]
  const logoImg    = design.assets[2]
  const iconImgs   = [design.assets[3], design.assets[4], design.assets[5], design.assets[6]]
