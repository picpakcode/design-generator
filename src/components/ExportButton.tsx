  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <button
        onClick={handleCopy}
        disabled={busy}
        className="w-full h-9 flex items-center justify-center gap-2 rounded-lg border border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-400 text-[11px] font-bold uppercase tracking-widest hover:border-gray-400 dark:hover:border-gray-400 hover:text-gray-700 dark:hover:text-gray-200 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
      >
      ...
      <button
        ...
        disabled={busy}
        className="w-full h-9 flex items-center justify-center gap-2 rounded-lg bg-gray-900 dark:bg-gray-700 text-white text-[11px] font-bold uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-gray-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
      >
      ...
      {altCanvasRef && (
        <button
          ...
          disabled={busy}
          className="w-full h-9 flex items-center justify-center gap-2 rounded-lg border border-dashed border-gray-300 dark:border-gray-600 text-gray-400 dark:text-gray-500 text-[11px] font-bold uppercase tracking-widest hover:border-gray-500 dark:hover:border-gray-400 hover:text-gray-600 dark:hover:text-gray-300 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
