  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <button
        onClick={handleCopy}
        disabled={busy}
        className="w-full h-9 flex items-center justify-center gap-2 rounded-lg border border-gray-200 text-gray-500 text-[11px] font-bold uppercase tracking-widest hover:border-gray-400 hover:text-gray-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
      >
      ...
      {altCanvasRef && (
        <button
          ...
          disabled={busy}
          className="w-full h-9 flex items-center justify-center gap-2 rounded-lg border border-dashed border-gray-300 text-gray-400 text-[11px] font-bold uppercase tracking-widest hover:border-gray-500 hover:text-gray-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
