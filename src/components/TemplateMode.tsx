...
export default function TemplateMode({
  ...
  const handleFile = useCallback((file: File) => {
    ...
    reader.onload = e => {
      ...
      for (const product of result.products) {
        initSlots[product.id] = Array.from({ length: aplusSlots }, (_, j) => {
        ...
        initGallery[product.id] = Array.from({ length: galleryCount }, (_, g) => {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [aplusSlots, galleryCount, onCanExportChange, onCanExportCurrentChange, onStatsChange])
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1 leading-relaxed">
              A+ columns: <code className="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded text-[10px]">a1_title</code> <code className="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded text-[10px]">a1_desc</code> <code className="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded text-[10px]">b1_title</code>…<br/>
              Gallery columns: <code className="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded text-[10px]">g1_title</code> <code className="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded text-[10px]">g1_desc</code> <code className="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded text-[10px]">g2_title</code>…
            </p>
          </div>
