  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        type="button"
        onClick={() => setOpen(o => !o)}
        className={`w-full flex items-center gap-2 px-2 py-1.5 rounded-none border text-[10px] transition-all ${
          open
      ...
      >
        {value ? (
          <>
            <div className="w-10 h-10 rounded-none border border-gray-200 dark:border-gray-600 overflow-hidden shrink-0 bg-white">
          ...
          <>
            <div className="w-10 h-10 rounded-none border border-dashed border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 flex items-center justify-center shrink-0">
      ...
      {open && dropPos && (
        <div
          ...
          className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-none shadow-xl overflow-hidden"
        >
          {loading ? (
