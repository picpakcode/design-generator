...
export const TEMPLATES: TemplateConfig[] = [
  ...
  {
    id: 'amazon-aplus-split-desktop',
    templateId: 'aplus-split',
    name: 'Desktop',
    platform: 'amazon',
    width: 1464,
    height: 600,
    format: 'desktop',
    category: 'A+ Content',
    description: 'Amazon A+ dual-photo desktop (1464×600)',
  },
  {
    id: 'amazon-aplus-split-mobile',
    templateId: 'aplus-split',
    name: 'Mobile',
    platform: 'amazon',
    width: 600,
    ...
    format: 'mobile',
    category: 'A+ Content',
    description: 'Amazon A+ dual-photo mobile (600×450)',
  },
  {
